...
public class Main {
    public static void main(String[] args) {
        ...
        Dev devJe = new Dev();
        devJe.setNome("Je");
        devJe.inscreverBootcamp(bootcamp);
        System.out.println("Conteúdos Inscritos Je:" + devJe.getConteudosInscritos());
        devJe.progredir();
        devJe.progredir();
        devJe.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Je:" + devJe.getConteudosInscritos());
        System.out.println("Conteúdos Concluidos Je:" + devJe.getConteudosConcluidos());
        System.out.println("XP:" + devJe.calcularTotalXp());
